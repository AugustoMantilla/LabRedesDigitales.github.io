...
int led = 1;  // Pin donde está conectado el LED
int PIR = 4;  // Pin donde está conectado el LED
...
String api_key = "NZUJ6QMBRY8VJSTS"; // Clave API personal del tablero en ThingSpeak
...
void setup() {
  ...
  WiFi.begin("Guty", "123456789");  // Nombre de la red WiFi y contraseña (vacía en este caso)
...
void loop() {
  ...
  delay(1000);  // Espera antes de enviar nuevamente
}
